...
dominance_relatedness <- select(dominance_relatedness, RankDiff, dyad, rab, pi_HAT, NonNormalizedP0)
...
ggplot(dominance_relatedness, aes(x = RankDiff, y = NonNormalizedP0, color = RankDiff)) +
