...
ggplot(ngsRelate_results_ID_group, aes(x = reorder(dyad, rab), y = rab, color = dyad_group, shape = dyad_group)) +
  ...
  ggtitle("distribution of relatedness (ngsrelate)")
...
ggplot(lcmlkin_results_ID_group_300k, aes(x = reorder(dyad, pi_HAT), y = pi_HAT, color = dyad_group, shape = dyad_group)) +
