...
ggplot(filter(READ_results_sample_info, a_Group != "mpala_chicks", b_Group != "mpala_chicks"), aes(x = dyad_group, y = NonNormalizedP0, color = dyad_sex)) +
...
ggplot(subset(relate_results, a_Group %in% c("mpala", "mpala_chicks") & b_Group %in% c("mpala", "mpala_chicks") & dyad_group %in% "intergroup"), aes(x = dyad_sex, y = NonNormalizedP0, color = dyad_sex)) +
